...
async function saveDatasetOnTmpDirAndS3(styleData, tmpDir, fileKeyPath) {
    ...
    const params = {
        ...
        Key: `${fileKeyPath}/datasets/Dataset-complete.xlsx`,
        Body: fileContent,
...
exports.saveScrappedDataV1 = async (tmpHTMLPath, filepathCSS, tmpDir, fileKeyPath) => {
    ...
    return await saveDatasetOnTmpDirAndS3(styleData, tmpDir, fileKeyPath)
}
